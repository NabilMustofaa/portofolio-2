...
const ProjectItem: React.FC<ProjectItemProps> = ({
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse p-12 bg-neutral-900 bg-opacity-75 gap-10 rounded-2xl my-4">
      ...
      <div className="flex-col text-white md:w-7/12">
        <div className="py-10 px-6 bg-neutral-500 bg-opacity-80 rounded-2xl">
          <Image
            src={image}
            alt={title}
            width={1000}
